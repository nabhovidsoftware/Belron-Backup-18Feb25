...
import showProduct from '@salesforce/apex/BLN_OldProductAvailabilty.createOrderItems';
       ...
       showProduct({ payload : this.payloadBody,
        ...
        .then(result=>{
           ...
           this.orderIdList = JSON.stringify(result);
            ...
            this.earlistAvailibilityDetailsList = JSON.parse(JSON.stringify(this.showProductData.earliestAvailabilityDetails));
