...
import { decrementAltText, incrementAltText, inputAriaLabel } from './lad_labels';
import { getLocale, getDecimalSeparator, getGroupingSeparator } from './lad_locale';
import { numberFormattedValue, findReason, first, isLessThanOrEqual } from './lad_utils';
...
export { stringOnlyHasNumbers } from './lad_utils';
...
export default class Lad_commonNumberInput extends LightningElement {
